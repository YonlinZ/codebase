...
namespace WTMFirst.ViewModel.Patients.PatientVMs
{
    public partial class PatientListVM : BasePagedListVM<Patient_View, PatientSearcher>
    {
        protected override List<GridAction> InitGridAction()
        {
            ...
            {
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.Create, Localizer["Create"],"Patients", dialogWidth: 800),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.Edit, Localizer["Edit"], "Patients", dialogWidth: 800),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.Delete, Localizer["Delete"], "Patients", dialogWidth: 800),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.Details, Localizer["Details"], "Patients", dialogWidth: 800),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.BatchEdit, Localizer["BatchEdit"], "Patients", dialogWidth: 800),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.BatchDelete, Localizer["BatchDelete"], "Patients", dialogWidth: 800),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.Import, Localizer["Import"], "Patients", dialogWidth: 800),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.ExportExcel, Localizer["Export"], "Patients"),
            };
        }
